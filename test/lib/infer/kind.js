...
test('inferKind', function(t) {
  ...
  t.equal(
    ...
    'class',
    'es6 syntax with default export'
  );
  ...
  t.equal(
    inferKind(toComment('class Foo { /** b */ b(v) { } }')).kind,
    'function',
    'normal function as part of class'
  );
