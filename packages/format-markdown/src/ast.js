/* @flow */
import type { Comment, CommentTag, DocumentationConfig } from 'documentation';

var u = require('unist-builder'),
  remark = require('remark'),
  // mergeConfig = require('../../_internal/merge_config'),
  toc = require('remark-toc'),
  hljs = require('highlight.js'),
  GithubSlugger = require('github-slugger'),
  LinkerStack = require('@documentation/format-utils/lib/linker_stack'),
  rerouteLinks = require('./reroute_links'),
  _formatType = require('./format_type');
 ...
 */
function markdownAST(comments: Array<Comment>, config: Object): Promise<string> {
