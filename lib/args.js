...
function parse(args) {
  ...
  .boolean('markdown-toc')
  .describe('markdown-toc', 'generate a table of contents in markdown output')
...
module.exports = function (args) {
  ...
  if (argv['markdown-toc'] && argv.f !== 'md') {
    yargs.showHelp();
    throw new Error('The --markdown-toc option is only valid in combination with -f md');
  }
